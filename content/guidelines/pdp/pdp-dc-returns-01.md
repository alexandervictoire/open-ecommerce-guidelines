...
Checks whether return conditions are clearly communicated on the PDP before the user commits to a purchase.
...
Provide clear and consistent return information on the PDP that is accessible before purchase commitment.
