---
id: PDP-DC-PRC-01
title: The total cost and unit-based pricing of the product should be clearly understandable before purchase
category: pdp
...
Whether the PDP enables users to clearly understand the true economic value of the product, including the total payable cost and, where relevant, the price per unit.
The user must be able to evaluate the offer without needing to calculate, estimate, or infer hidden cost structures.
